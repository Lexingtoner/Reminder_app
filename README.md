...
- **Добавление напоминаний**: Создание новых напоминаний с текстом, датой, временем, приоритетом и категорией
- **Редактирование напоминаний**: Изменение существующих напоминаний
- **Просмотр списка**: Отображение всех сохраненных напоминаний в виде списка с поиском
- **Удаление напоминаний**: Возможность удалить ненужные напоминания
- **Приоритеты**: Установка уровня важности (Высокий/Обычный/Низкий) с цветовой индикацией
- **Категории**: Организация напоминаний по категориям (Работа/Личное/Покупки/Здоровье/Другое)
- **Поиск и фильтрация**: Поиск напоминаний по тексту или категории в реальном времени
- **Отметить выполненным**: Возможность отметить напоминание как выполненное
- **Уведомления**: Автоматические уведомления в указанное время
...
- [x] Уведомления в указанное время
- [x] Категории напоминаний
- [x] Приоритеты напоминаний  
- [x] Функция поиска и фильтрации
